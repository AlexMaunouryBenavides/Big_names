				...
				<div className="md:flex   flex-row-reverse justify-between  md:w-[1700px] md:m-auto">
					<div className=" px-3 py-5 md:w-[30%] md:h-[50vh] md:border-l-[1px] border-l-black ">
						...
						<motion.div
							...
							className={` flex gap-3 flex-wrap flex-col text-[#FB4B4E] font-['Plu_Jakart_Sans'] py-5 `}>
							<motion.button
								whileHover={{ scale: 0.9, color: '#F1F2F6' }}
								transition={{ type: 'spring', stiffness: 120, duration: 0.2 }}
								onClick={handleClickCategorie}
								className="px-10 py-1 rounded-lg bg-[#000501] ">
								Europe
							</motion.button>
							<motion.button
								whileHover={{ scale: 0.9, color: '#F1F2F6' }}
					...
					<div className="  flex flex-wrap justify-center md:justify-start md:w-[70%] md:content-start gap-3 pb-5 ">
							...
							<motion.div
								...
								<Link to={`/list/${element.id}`}>
									<motion.h3
										whileHover={{ scale: 0.9, color: '#F1F2F6' }}
										transition={{ type: 'spring', stiffness: 120, duration: 0.2 }}
										className="md:text-[24px] py-[5px] px-3 bg-[#FB4B4E] rounded-lg text-[#000] font-['Cinzel_Decorative']">
										{element.nom}
									</motion.h3>
								</Link>
							</motion.div>
